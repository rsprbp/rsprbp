# 💫 About Me:
(Tech)<br><br>⇨ Reverse Engineering (ARM64/x86)<br>⇨ Full-Stack Webdev<br>⇨ Game Hacking<br>⇨ Looking to pwn MacOS eventually<br>(Gameservers)<br><br>⇨ 10+ years gameserver management & development<br>⇨ Lead Developer for Europa Roleplay SA:MP (current)<br>⇨ Rage:MP (MafiaCityRP/ORP) developer<br>⇨ SA:MP CnR (SFC) contributor<br>⇨ FiveM FantasyDrift former owner<br>⇨ Minecraft FlowMC former owner<br><br><br>I love to play around with technology and find new ways to reinvent the wheel ;D
...
---
[![](https://visitcount.itsvg.in/api?id=rsprbp&icon=0&color=8)](https://visitcount.itsvg.in)
